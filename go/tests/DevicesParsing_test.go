...
// TestFullDevicesParsing tests the complete device parsing flow for multiple devices.
// It simulates a multi-device environment and verifies that all devices are correctly
// parsed and stored in the inventory.
